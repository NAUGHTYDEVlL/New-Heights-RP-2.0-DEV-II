...
table.insert(Config.DoorList, {
	...
	audioRemote = false,
	doors = {
		{objHash = -434783486, objHeading = 340.00003051758, objCoords = vector3(312.0052, -571.3412, 43.43392)},
		{objHash = -1700911976, objHeading = 340.00003051758, objCoords = vector3(314.4242, -572.2216, 43.43392)}
 	},		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
table.insert(Config.DoorList, {
	...
	audioRemote = false,
	doors = {
		{objHash = -434783486, objHeading = 340.00003051758, objCoords = vector3(317.8426, -573.4658, 43.43392)},
		{objHash = -1700911976, objHeading = 340.00003051758, objCoords = vector3(320.2616, -574.3464, 43.43392)}
 	},		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
table.insert(Config.DoorList, {
	...
	audioRemote = false,
	doors = {
		{objHash = -434783486, objHeading = 340.00003051758, objCoords = vector3(323.2376, -575.4294, 43.43392)},
		{objHash = -1700911976, objHeading = 340.00003051758, objCoords = vector3(325.6566, -576.31, 43.43392)}
 	},		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
table.insert(Config.DoorList, {
	...
	audioRemote = false,
	doors = {
		{objHash = -434783486, objHeading = 160.00003051758, objCoords = vector3(318.4846, -579.2282, 43.43392)},
		{objHash = -1700911976, objHeading = 160.00003051758, objCoords = vector3(316.0658, -578.3478, 43.43392)}
 	},		
	-- oldMethod = true,
	-- audioLock = {['file'] = 'metal-locker.ogg', ['volume'] = 0.6},
	-- audioUnlock = {['file'] = 'metallic-creak.ogg', ['volume'] = 0.7},
...
table.insert(Config.DoorList, {
	doors = {
		{objHash = -434783486, objHeading = 70.006050109864, objCoords = vector3(338.4466, -590.053, 28.9471)},
		{objHash = -1700911976, objHeading = 70.006050109864, objCoords = vector3(339.3266, -587.6346, 28.9471)}
 },
	lockpick = false,
	locked = true,
	maxDistance = 2.5,
...
table.insert(Config.DoorList, {
	doors = {
		{objHash = 1674289593, objHeading = 70.006050109864, objCoords = vector3(340.7712, -583.942, 27.79682)},
		{objHash = -1048421071, objHeading = 70.006050109864, objCoords = vector3(340.1254, -585.717, 27.79682)}
 	},
	lockpick = false,
	locked = true,
	maxDistance = 2.0,
...
table.insert(Config.DoorList, {
	doors = {
		{objHash = 1674289593, objHeading = 70.006050109864, objCoords = vector3(342.1202, -580.2346, 27.79682)},
		{objHash = -1048421071, objHeading = 70.006050109864, objCoords = vector3(341.4744, -582.0096, 27.79682)}
	},
	lockpick = false,
	locked = true,
	maxDistance = 2.0,
...
table.insert(Config.DoorList, {
	doors = {
		{objHash = -1421582160, objHeading = 25.005989074708, objCoords = vector3(321.0148, -559.9128, 28.94724)},
